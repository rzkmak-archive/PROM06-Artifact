...
export default function () {
    ...
    const initResponse = http.post('http://127.0.0.1:8081/v1/self/cyberbully/initialize', JSON.stringify({
    ...
    const screeningResponse = http.post('http://127.0.0.1:8081/v1/self/cyberbully/screening/twitter', JSON.stringify({
